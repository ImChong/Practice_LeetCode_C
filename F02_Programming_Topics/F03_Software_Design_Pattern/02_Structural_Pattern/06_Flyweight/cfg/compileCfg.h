/*
 * @FilePath     : \Practice_LeetCode_C\02_Programming_Topics\03_Design_Pattern\01_Singleton\cfg\compileCfg.h
 * @Author       : Chong Liu
 * @CreateDate   : 2023-11-23 01:23:40
 * @LastEditors  : Chong Liu
 * @LastEditTime : 2024-01-02 18:49:27
 * =================================================================================
 * Copyright (c) 2023 by Chong Liu, All Rights Reserved.
 * =================================================================================
 * @Description  : common function compilation configuration file Common function configuration file (通用函数配置文件)
 */
