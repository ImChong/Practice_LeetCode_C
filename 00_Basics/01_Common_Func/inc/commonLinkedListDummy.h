 ...
 * @LastEditTime : 2023-11-07 01:15:12
 * =================================================================================
...
int myLinkedListGet(DummyLinkedList *dummyHead, int index);        /* 获取链表中第index个节点的值 */
void myLinkedListAddAtHead(DummyLinkedList *dummyHead, int val);       /* 在链表头部添加一个节点 */
