/*
 * @FilePath     : \Practice_LeetCode_C\F01_Common_Functions\test\commonSingleValueTest.cc
 * @Author       : Chong Liu
 * @CreateDate   : 2023-12-16 00:25:02
 * @LastEditors  : Chong Liu
 * @LastEditTime : 2024-01-12 23:59:07
 * =================================================================================
 * Copyright (c) 2023 by Chong Liu, All Rights Reserved.
 * =================================================================================
 * @Description  : Common Single Value Unit Test (通用单值单元测试)
 */
extern "C" {
