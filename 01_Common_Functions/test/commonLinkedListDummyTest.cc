/*
 * @FilePath     : \Practice_LeetCode_C\00_Basics\01_Common_Func\test\commonLinkedListDummyTest.cc
 * @Author       : Chong Liu
 ...
 * =================================================================================
 * @Description  : 通用链表头单元测试 - 未使用虚拟头节点
 */
/* gtest 头文件 */
...
/*                                                                                */
/**********************************************************************************/
class TestCommonLinkedListDummy : public ::testing::Test {
 public:
